...
namespace Appr_Part2.Models
{
    public class Appr_Part2_DbContext : DbContext
    {
        public Appr_Part2_DbContext(DbContextOptions<Appr_Part2_DbContext> options) : base(options)
        {
        }
